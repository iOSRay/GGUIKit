...
+ (void)showDatePickerWithMode:(UIDatePickerMode)mode
        ...
        barButtonItemTintColor:(UIColor *)barButtonItemTintColor
               selectedClosure:(DateBlock)selectedClosure {
...
+ (NSString*)stringFromDate:(NSDate*)aDate format:(NSString*)dateFormat{
    return [self stringFromDate:aDate
                         format:dateFormat
                       timeZone:[NSTimeZone localTimeZone]
                     dateLocale:[NSLocale localeWithLocaleIdentifier:@"en_US"]];
}
